...
Not an assumption but I felt that toggle movements all being implemented in a uniform direction for a specific viewport was more user friendly. Hence the design choice not to recreate styles such as that in Figma Group 48096222.
